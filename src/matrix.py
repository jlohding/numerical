...
class Matrix:
    def __init__(self, values: List[List[float] or Vector] or Tuple[int, int]):
        ...
        if isinstance(values, tuple):
            ...
            if isinstance(values[0], Vector):
                ...
                raise Exception("Wrong input type: List must nest either List or Vector")
    ...
    def p_norm(self, p: float) -> float:
        ...
        '''
        raise NotImplementedError("matrix norm has not been implemented yet in this library")
